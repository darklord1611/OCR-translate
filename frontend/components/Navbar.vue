<template>
    <div class="navbar w-full fixed z-50 opacity-90 px-4 bg-red-500">
        <div class="navbar-start">
            <nuxt-link to="/" class="btn btn-ghost text-xl text-white">OCR - Translator</nuxt-link>
        </div>
...
const toggleTheme = () => {
    colorMode.preference = colorMode.preference === themes.light ? themes.dark : themes.light;
